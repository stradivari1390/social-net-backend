...
```
cd existing_repo
git remote add origin https://gitlab.skillbox.ru/javapro_team38/social-net-backend.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.skillbox.ru/javapro_team38/social-net-backend/-/settings/integrations)
